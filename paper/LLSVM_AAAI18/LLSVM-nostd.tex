...
\begin{document}
	...
	\begin{figure*}[!htb]
		\centering
		\subfigure[]{\includegraphics[width=0.45\textwidth]{knn1.pdf}}
		\hfill
		\subfigure[]{\includegraphics[width=0.45\textwidth]{knn2.pdf}}
...
%	\end{figure}
	...
	\begin{figure*}[!htb]
		...
		\subfigure[Magic04]{
			\includegraphics[width=0.32\textwidth]{figs/magic04.pdf}
		}
		\subfigure[IJCNN]{
		...
		\subfigure[connect-4]{
			\includegraphics[width=0.32\textwidth]{figs/connect4.pdf}
		}
		\subfigure[Covtype]{
	...
	\begin{figure*}[!htb]
		\centering
		\subfigure[phishing]{
			\includegraphics[width=0.32\textwidth]{figs/phishing_nn.pdf}
		}
		\subfigure[Magic04]{
			\includegraphics[width=0.32\textwidth]{figs/magic04_nn.pdf}
		}
		\subfigure[IJCNN]{
			\includegraphics[width=0.32\textwidth]{figs/ijcnn_nn.pdf}
		}
		\subfigure[w8a]{
			\includegraphics[width=0.32\textwidth]{figs/w8a_nn.pdf}
		}
		\subfigure[connect-4]{
			\includegraphics[width=0.32\textwidth]{figs/connect4_nn.pdf}
		}
		\subfigure[Covtype]{
			\includegraphics[width=0.32\textwidth]{figs/covtype_nn.pdf}
		}
		\caption{Epoch-wise demonstration of LLC-DJO nn learning curve on test data}
		\label{allfig}
	\end{figure*}
